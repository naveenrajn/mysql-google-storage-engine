...
ELSE(LIBXMLPP_LIBRARY AND LIBXMLPP_INCLUDE_DIR)
	...
	IF(LIBXMLPP_INCLUDE_DIR AND LIBXMLPP_LIBRARY)
		...
		MESSAGE(STATUS "_LibXmlppIncDir: ${_LibXmlppIncDir}")
		MESSAGE(STATUS "_LibXmlppLibDir: ${_LibXmlppLibDir}")
		MESSAGE(STATUS "_LibXmlppLinkFlags: ${_LibXmlppLinkFlags}")
		MESSAGE(STATUS "_LibXmlppCflags: ${_LibXmlppCflags}")
		MESSAGE(STATUS "LIBXMLPP_CFLAGS: ${LIBXMLPP_CFLAGS}")
